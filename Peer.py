...
# Lock for managing all access to globally shared elements.
# Note: This lock is shared between pieces access and swarm/current_peers
# access since there was no observed benefit to using a separate lock for each.
lock = threading.Lock()
